...
local on_attach = function(client, bufnr) local navic_ok, navic = pcall(require, 'nvim-navic')
  if navic_ok and
  ...
  vim.keymap.set('n', '<leader>D',
    vim.lsp.buf.type_definition, bufopts)
...
for _, server in ipairs(servers) do local ok, config = pcall(require, 'user.lsp.' .. server)
  if not ok then
